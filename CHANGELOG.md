...
## 2.0.1(2021-12-15)
* [#22774] log4j 的漏洞修复，升级至2.16.0 pom.xml

## 2.0.1(2021-06-11)
* [#20859] 增加对nacos中MySQL的密码解密功能: com.alibaba.nacos.config.server.service.datasource.ExternalDataSourceProperties

> 以上修复在官方nacos-2.0.0版本的基础上进行修改。源码地址：[https://github.com/alibaba/nacos/tree/2.0.0](https://github.com/alibaba/nacos/tree/2.0.0)
